...
class BertChecker(Corrector):
    ...
    def __init__(self, model_name, **kwargs):
        ...
        self.bert_pretrained_name_or_path = model_name #"bert-base-cased"

    def load_model(self, ckpt_path):
        print(f"initializing model")
        # if "distilbert" in ckpt_path:
        #     initialized_model = create_model(self.vocab, "distilbert-base-cased")
        # else:
        initialized_model = create_model(self.vocab, self.bert_pretrained_name_or_path)
    ...
    def get_name(self):
        return self.bert_pretrained_name_or_path
    ...
    def correct_strings(self, mystrings: List[str], return_all=False) -> List[str]:
        self.is_model_ready()
        mystrings = bert_tokenize_for_valid_examples(mystrings, mystrings, "bert-base-cased")[0]
    ...
    def from_huggingface(self, bert_pretrained_name_or_path, vocab: Union[Dict, str]):
        ...
        self.model = create_model(self.vocab, bert_pretrained_name_or_path=self.bert_pretrained_name_or_path)
    ...
    def finetune(self,
        ...
        TRAIN_BATCH_SIZE, VALID_BATCH_SIZE = 4, 32 #16, 32
        GRADIENT_ACC = 64 # 4
        DEVICE = self.device
        ...
        for epoch_id in range(START_EPOCH, N_EPOCHS + 1):
            ...
            if valid_acc >= max_dev_acc:
                ...
                name = "pytorch_model_" + str(epoch_id) + ".bin"
